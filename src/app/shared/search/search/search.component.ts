...
export class SearchComponent implements OnInit {
  ...
  constructor() {
    this.data = [{"nombre":"varius nulla facilisi cras non velit nec nisi vulputate nonummy maecenas tincidunt lacus at velit vivamus vel nulla","precio":77,"codigoBarras":86,"cantidad":65,"fecha":"5/1/2020"},
  ];
